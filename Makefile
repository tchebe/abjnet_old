...
dockerload_all:
	cd .. && cd .. && cd shared/containerimages && sudo docker load --input abjnet_user_service.tar && sudo docker load --input abjnet_product_service.tar && sudo docker load --input abjnet_souscription_service.tar && sudo docker load --input abjnet_payment_service.tar && sudo docker load --input abjnet_prestation_service.tar && sudo docker load --input abjnet_email_service.tar && sudo docker load --input abjnet_taskrunner_service.tar && sudo docker load --input abjnet_api_rest.tar    
